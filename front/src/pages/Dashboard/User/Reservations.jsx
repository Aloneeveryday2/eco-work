    ...
    <div style={{ animation: "fadeIn 0.4s ease" }}>
          ...
          {filters.map((f) => (
            <button
              ...
              style={{
                ...
                borderRadius: "8px",
                border: `1px solid ${
                  filter === f ? "#1a3a45" : "rgba(26,58,69,0.12)"
                }`,
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: "0.75rem", color: "#4a7a85" }}>
                ...
                <div style={{ textAlign: "right" }}>
                  ...
                  <span
                    style={{
                      ...
                      borderRadius: "100px",
                      background: r.facture_acquittee
                        ? "rgba(74,222,128,0.1)"
                        : "rgba(251,191,36,0.1)",
      ...
      {deleteConfirm && (
        ...
        >
          ...
          >
            Cette réservation sera annulée définitivement. Cette action est
            irréversible.
          </p>
